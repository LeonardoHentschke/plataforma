...
<nav class="navbar navbar-expand-md navbar-dark bg-primary">
  ...
  <div class="container-fluid">
    ...
    <table class="table table-default table-hover table-bordered" style="text-align: center;">              
            ...
            <?php            
            $sql = "SELECT o.id_oportunidade, e.razao_social, e.segmento FROM empresas_crm e, oportunidade_crm o WHERE o.`status`= 4 AND o.id_empresa = e.id_empresa";
            $sql = $pdo -> query($sql);
            ...
            {        
                foreach($sql->fetchALL() as $usuario)
                {
                    ...
                    echo '<td><a class="text-primary" href="views/viewInteressado.php?id_oportunidade='.$usuario['id_oportunidade'].'">Detalhes</a>';
                    echo '</tr>';
                }
            }else
            {
