...
<body style="background-color: #DCDCDC; color: #000">
      ...
      <nav class="navbar navbar-expand-md navbar-dark bg-primary">
        <div class="d-flex w-95">
            <a class="navbar-brand mr-0" href="" style="font-family: cursive;">CRM</a>
  ...
  <div class="container-fluid">
    ...
    <div class="col-6">
      <a class="btn btn-outline-primary" href="nova-oportunidade.php" style="margin-bottom: 15px;">Nova oportunidades</a>
      <a class="btn btn-outline-primary" href="cadastro-de-cliente.php" style="margin-bottom: 15px;">Cadastro de cliente</a>
      <a class="btn btn-outline-primary" href="allclientes.php" style="margin-bottom: 15px;">Editar Clientes</a>
    </div>    
  </div>
    ...
    <table class="table table-default table-hover table-bordered" style="text-align: center;">              
            ...
            <?php            
            $sql = "SELECT o.id_oportunidade, e.razao_social, e.segmento FROM empresas_crm e, oportunidade_crm o WHERE o.`status`= 1 AND o.id_empresa = e.id_empresa";
            $sql = $pdo -> query($sql);
            ...
            {        
                foreach($sql->fetchALL() as $usuario)
                {
                    ...
                    echo '<td><a class="text-primary" href="views/viewOportunidade.php?id_oportunidade='.$usuario['id_oportunidade'].'">Detalhes</a>';
                    echo '<td><a class="btn btn-primary" href="agendar.php?id_oportunidade='.$usuario['id_oportunidade'].'">Agendar</a>';
                    echo '</tr>';
                }
            }else
            {
