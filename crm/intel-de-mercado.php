        ...
        <nav class="navbar">
          ...
          <form class="form-inline">
            <div class="btn-group">
              ...
              <a class="btn btn-primary" href="intel-de-mercado.php" role="button">Inteligência de Mercado</a>
              <a class="btn btn-outline-primary" href="indicadores.php" role="button">Indicadores</a>
