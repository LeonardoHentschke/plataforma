...
if(isset($_POST['motivo_interesse']) && empty($_POST['motivo_interesse'])==false ){

  $motivo_interesse     =addslashes($_POST['motivo_interesse']);

        
  $sql = "UPDATE oportunidade_crm SET motivo_interesse='$motivo_interesse', status='4' WHERE id_oportunidade='$id_oportunidade'";
                ...
                <form method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control" name="motivo_interesse" required>
