...
<body style="background-color: #DCDCDC; color: #000">
  ...
  <div class="container-fluid">
   ...
   <table class="table table-default table-hover table-bordered" style="text-align: center;">              
            ...
            <?php            
            $sql = "SELECT o.id_oportunidade, e.razao_social, e.segmento FROM empresas_crm e, oportunidade_crm o WHERE o.`status`= 2 AND o.id_empresa = e.id_empresa";
            $sql = $pdo -> query($sql);
            ...
            {        
                foreach($sql->fetchALL() as $usuario)
                {
                    ...
                    echo '<td><a href="views/viewAgendamentos.php?id_oportunidade='.$usuario['id_oportunidade'].'">Detalhes</a>';
                    echo '<td><a class="btn btn-primary" href="followupar.php?id_oportunidade='.$usuario['id_oportunidade'].'">Follow-Up</a>';
                    echo '</tr>';
                }
            }else
            {
