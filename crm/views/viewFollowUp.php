...
$sql = "SELECT e.razao_social, e.email, e.cnpj_cpf, e.cidade, o.origem, o.tipo, o.descricao, o.primeiro_contato, o.data_agendada, o.hora_agendada, o.formato_reuniao,
            ...
            <div class="col">
                <form method="POST">
                    ...
                    <div class="form-row">                        
                      ...
                      <div class="col-md-4">
                        <a href="../follow-up.php" class="btn btn-secondary btn-block">Voltar</a>
                      </div>
