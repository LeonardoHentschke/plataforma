...
$sql = "SELECT e.razao_social, e.email, e.cnpj_cpf, e.cidade, o.origem, o.tipo, o.descricao, o.primeiro_contato, o.data_agendada, o.hora_agendada, o.formato_reuniao FROM oportunidade_crm o, empresas_crm e WHERE o.id_oportunidade = '$id_oportunidade' AND e.id_empresa = o.id_empresa";
$sql = $pdo -> query($sql);
            ...
            <div class="col">
                <form method="POST">
                    ...
                    <div class="form-row">                        
                      ...
                      <div class="col-md-4">
                        <a href="../agendamentos.php" class="btn btn-secondary btn-block">Voltar</a>
                      </div>
